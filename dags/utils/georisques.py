...
def insert_store_risks(cur, gie_records: list[dict[str, Any]]) -> None:
    """Insert Store risk mappings into PostgreSQL."""
    if not gie_records:
        return
    ...
    execute_values(
        cur,
        """
        INSERT INTO georisques_store_risks (
            store_name, insee_code, commune, postal_code,
        ...
        ON CONFLICT (store_name, extraction_date)
        DO UPDATE SET
